...
class _IndiaMapScreenState extends State<IndiaMapScreen> {
  ...
  void _onStateTap(_StateInfo state) {
    final hasPlaces =
        allPlaces.any((p) => p.state.toLowerCase() == state.name.toLowerCase());
    if (!hasPlaces) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content:
              Text('Coming soon: ${state.name}', style: GoogleFonts.poppins()),
